...
import { appParser, arithParser, conjunctionParser, disjunctionParser, factorParser, relParser, termParser } from "./Parser"
...
const nodeMaybe = disjunctionParser(tokens)
